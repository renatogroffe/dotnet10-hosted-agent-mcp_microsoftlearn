...
AIAgent agent = new AIProjectClient(projectEndpoint, new DefaultAzureCredential())
    .AsAIAgent(
        model: deployment,
        instructions: """
            Você é um Agent que utiliza as tools do MCP Server do Microsoft Learn e que,
            a partir disso, traz orientações sobre certificações Microsoft para um
            usuário interessado nas mesmas.
            Seja conciso e forneça respostas diretas com links relevantes.
            """,
        name: "mcp-tools",
        description: "Assiste de Desenvolvimento com dual-layer MCP tools (client-side e server-side)",
        tools: allTools);
